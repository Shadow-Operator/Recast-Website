  ...
  return (
    ...
    >
      ...
      <ul className="hidden lg:flex items-center gap-8 xl:gap-10">
        ...
        <li>
          <a href="#contact" className="bg-blue-accent text-white font-semibold text-[13px] px-5 xl:px-6 py-2.5 hover:bg-blue-glow transition-colors">
            Get started
          </a>
        </li>
      </ul>
      ...
      {mobileOpen && (
        <div
          className="absolute top-full left-0 right-0 border-b border-border/30 lg:hidden backdrop-blur-sm"
